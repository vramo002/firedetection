...
center = (int(x), int(y))
radius = int(radius)
cv2.circle(img, (round(centroids[2][0]), round(centroids[2][1])), radius, (155, 0, 0), 2)
print(center)
...
center = (int(x), int(y))
radius = int(radius)
cv2.circle(img, (round(centroids[1][0]), round(centroids[1][1])), radius, (155, 0, 0), 2)
print(center)
